...
var reducer = (function (state, action) {
  ...
  if (action.type === 'UPDATE_DROPPABLE_IS_ENABLED') {
    ...
    !(_target.isEnabled === isEnabled) ? process.env.NODE_ENV !== "production" ? invariant(false, "Trying to set droppable isEnabled to " + String(isEnabled) + " but it is already " + String(isEnabled)) : invariant(false) : void 0;
...
var DragDropContext = function (_React$Component) {
  ...
  function DragDropContext(props, context) {
    ...
    _this.storeContext = React.createContext(undefined);
...
var Droppable2 = function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement(ConnectedDroppable, this.props);
  };
...
var DragHandle = function (_Component) {
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    var dragHandleRef = getDragHandleRef(draggableRef);
    !dragHandleRef ? process.env.NODE_ENV !== "production" ? invariant(false, 'DragHandle could not find drag handle element') : invariant(false) : void 0;
...
var Draggable = function (_Component) {
  ...
  _proto.throwIfCannotDrag = function throwIfCannotDrag() {
    !!this.props.isDragDisabled ? process.env.NODE_ENV !== "production" ? invariant(false, 'Draggable: cannot drag as dragging is not enabled') : invariant(false) : void 0;
  };
...
var Draggable2 = function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement(ConnectedDraggable, this.props);
  };
...
export { storeContextKey, DragDropContext, Droppable2 as Droppable, Draggable2 as Draggable, resetServerContext };
